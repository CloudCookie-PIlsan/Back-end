...
public class ManitoController {
    ...
    public TodayManitoResponseDto getTodayManito() {
        return manitoService.getTodayManito();
    }
    ...
    public YesterdayManitoResponseDto getYesterdayManito() {
        return manitoService.getYesterdayManito();
    }
    ...
    public AnswerResponseDto postAnswer(@RequestBody AnswerRequestDto answerRequestDto) {
        return manitoService.postAnswer(answerRequestDto);
    }
}
